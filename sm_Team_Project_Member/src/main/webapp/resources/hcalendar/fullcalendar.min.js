 ...
 */
! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("moment"), require("superagent")) : "function" == typeof define && define.amd ? define(["moment", "superagent"], e) : "object" == typeof exports ? exports.FullCalendar = e(require("moment"), require("superagent")) : t.FullCalendar = e(t.moment, t.superagent)
    ...
    return function(t) {
        ...
        function n(t, e, n) {
            ...
            if (e)
                for (var i in e) "style" === i ? y(r, e[i]) : b[i] ? r[i] = e[i] : r.setAttribute(i, e[i]);
            return "string" == typeof n ? r.innerHTML = n : null != n && a(r, n), r
        }

        function r(t) {
            t = t.trim();
            var e = document.createElement(s(t));
            return e.innerHTML = t, e.firstChild
        }

        function i(t) {
            return Array.prototype.slice.call(o(t))
        }
        ...
        function s(t) {
            return E[t.substr(0, 3)] || "div"
        }

        function a(t, e) {
            for (var n = d(e), r = 0; r < n.length; r++) t.appendChild(n[r])
        }

        function l(t, e) {
            for (var n = d(e), r = t.firstChild || null, i = 0; i < n.length; i++) t.insertBefore(n[i], r)
        }

        function u(t, e) {
            for (var n = d(e), r = t.nextSibling || null, i = 0; i < n.length; i++) t.parentNode.insertBefore(n[i], r)
        }

        function d(t) {
            return "string" == typeof t ? o(t) : t instanceof Node ? [t] : t
        }
        ...
        function f(t, e) {
            for (var n = t instanceof HTMLElement ? [t] : t, r = [], i = 0; i < n.length; i++)
                for (var o = n[i].querySelectorAll(e), s = 0; s < o.length; s++) r.push(o[s]);
            return r
        }
        ...
        function y(t, e, n) {
            for (var r in e) m(t, r, e[r])
        }

        function m(t, e, n) {
            null == n ? t.style[e] = "" : "number" == typeof n && S.test(e) ? t.style[e] = n + "px" : t.style[e] = n
        }
        ...
        e.createElement = n, e.htmlToElement = r, e.htmlToElements = i, e.appendToElement = a, e.prependToElement = l, e.insertAfterElement = u, e.removeElement = c;
        var w = Element.prototype.matches || Element.prototype.matchesSelector || Element.prototype.msMatchesSelector,
            D = Element.prototype.closest || function(t) {
                var e = this;
        ...
        e.elementClosest = p, e.elementMatches = h, e.findElements = f, e.findChildren = g, e.forceClassName = v;
        var S = /(top|left|right|bottom|width|height)$/i;
        e.applyStyle = y, e.applyStyleProp = m
    }, function(t, e, n) {
        function r(t, e) {
            e.left && T.applyStyle(t, {
                borderLeftWidth: 1,
                marginLeft: e.left - 1
            }), e.right && T.applyStyle(t, {
                borderRightWidth: 1,
                marginRight: e.right - 1
            })
        }
        ...
        function a(t, e, n) {
            var r = Math.floor(e / t.length),
                ...
                a = [],
                u = 0;
            l(t), t.forEach(function(e, n) {
                var l = n === t.length - 1 ? i : r,
                    d = R.computeHeightAndMargins(e);
                d < l ? (o.push(e), s.push(d), a.push(e.offsetHeight)) : u += d
            }), n && (e -= u, r = Math.floor(e / o.length), i = Math.floor(e - r * (o.length - 1))), o.forEach(function(t, e) {
                var n = e === o.length - 1 ? i : r,
                    l = s[e],
                    u = a[e],
                    d = n - (l - u);
                l < n && (t.style.height = d + "px")
            })
        }
        ...
        function d(t, e) {
            ...
            T.applyStyle(t, n), T.applyStyle(e, n);
            var r = t.offsetHeight - e.offsetHeight,
                i = {
                    position: "",
                    left: ""
                };
            return T.applyStyle(t, i), T.applyStyle(e, i), r
        }

        function c(t) {
            t.classList.add("fc-unselectable"), t.addEventListener("selectstart", M.preventDefault)
        }

        function p(t) {
            t.classList.remove("fc-unselectable"), t.removeEventListener("selectstart", M.preventDefault)
        }

        function h(t) {
            var e, n, r = [],
                i = [];
            for ("string" == typeof t ? i = t.split(/\s*,\s*/) : "function" == typeof t ? i = [t] : Array.isArray(t) && (i = t), e = 0; e < i.length; e++) n = i[e], "string" == typeof n ? r.push("-" === n.charAt(0) ? {
                field: n.substring(1),
                order: -1
            } : {
                field: n,
        ...
        function g(t, e, n, r, i) {
            ...
            var o = t[n.field],
                s = e[n.field];
            return null == o && r && (o = r[n.field]), null == s && i && (s = i[n.field]), v(o, s) * (n.order || 1)
        }

        function v(t, e) {
            return t || e ? null == e ? -1 : null == t ? 1 : "string" == typeof t || "string" == typeof e ? String(t).localeCompare(String(e)) : t - e : 0
        }
        ...
        var T = n(3),
            R = n(13),
            M = n(10);
        e.compensateScroll = r, e.uncompensateScroll = i, e.disableCursor = o, e.enableCursor = s, e.distributeHeight = a, e.undistributeHeight = l, e.matchCellWidths = u, e.subtractInnerElHeight = d, e.preventSelection = c, e.allowSelection = p, e.parseFieldSpecs = h, e.compareByFieldSpecs = f, e.compareByFieldSpec = g, e.flexibleCompare = v, e.log = y, e.warn = m, e.applyAll = b, e.firstDefined = E, e.capitaliseFirstLetter = w, e.compareNumbers = D, e.isInt = S, e.debounce = C
    }, function(t, e) {
        function n(t) {
            ...
            if (e)
                for (n = 0; n < e.length; n++) {
                    for (r = e[n], i = [], o = t.length - 1; o >= 0; o--)
                        if ("object" == typeof(a = t[o][r]) && a) i.unshift(a);
                        else if (void 0 !== a) {
                        u[r] = a;
                        break
                    }
        ...
        e.assignTo = n, e.isEmptyObject = r, e.copyOwnProps = i, e.mergeProps = s
    }, function(t, e) {
        function n(t) {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.htmlEscape = n, e.stripHtmlEntities = r, e.cssToStr = i, e.attrsToStr = o
    }, function(t, e, n) {
        function r(t, e) {
        ...
        function o(t, e, n) {
            return g.duration(Math.round(t.diff(e, n, !0)), n)
        }

        function s(t, n) {
            var r, i, o;
            for (r = 0; r < e.unitsDesc.length && (i = e.unitsDesc[r], !((o = l(i, t, n)) >= 1 && v.isInt(o))); r++);
            return i
        }

        function a(t, e) {
            var n = s(t);
            return "week" === n && "object" == typeof e && e && e.days && (n = "day"), n
        }

        function l(t, e, n) {
            return null != n ? n.diff(e, t, !0) : g.isDuration(e) ? e.as(t) : e.end.diff(e.start, t, !0)
        }

        function u(t, e, n) {
            var r;
            return p(n) ? (e - t) / n : (r = n.asMonths(), Math.abs(r) >= 1 && v.isInt(r) ? e.diff(t, "months", !0) / r : e.diff(t, "days", !0) / n.asDays())
        }

        function d(t, e) {
            var n, r;
            return p(t) || p(e) ? t / e : (n = t.asMonths(), r = e.asMonths(), Math.abs(n) >= 1 && v.isInt(n) && Math.abs(r) >= 1 && v.isInt(r) ? n / r : t.asDays() / e.asDays())
        }

        function c(t, e) {
            var n;
            return p(t) ? g.duration(t * e) : (n = t.asMonths(), Math.abs(n) >= 1 && v.isInt(n) ? g.duration({
                months: n * e
            }) : g.duration({
                days: t.asDays() * e
            }))
        ...
        var r = n(2),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.parse = function(t, e) {
                    var n = new this(e);
                    return !("object" != typeof t || !t || !n.applyProps(t)) && n
                }, e.normalizeId = function(t) {
                    return t ? String(t) : null
                }, e.prototype.fetch = function(t, e, n, r, i) {}, e.prototype.removeEventDefsById = function(t) {}, e.prototype.removeAllEventDefs = function() {}, e.prototype.getPrimitive = function(t) {}, e.prototype.parseEventDefs = function(t) {
                    var e, n, r = [];
                    ...
                    return e && (t = e(t, this.calendar)), n && (t = n(t, this.calendar)), s.default.parse(t, this)
                }, e.prototype.applyManualStandardProps = function(t) {
                    return null != t.id && (this.id = e.normalizeId(t.id)), Array.isArray(t.className) ? this.className = t.className : "string" == typeof t.className && (this.className = t.className.split(/\s+/)), !0
        ...
        e.default = a, i.default.mixInto(a), a.defineStandardProps({
            id: !1,
            className: !1,
            color: !0,
            backgroundColor: !0,
        ...
        function l(t, e, n, r) {
            function i(t) {
                var e = c.elementClosest(t.target, n);
                e && r.call(e, t, e)
            }
        ...
        function u(t, e, n, r) {
            var i;
            return l(t, "mouseover", e, function(t, e) {
                if (e !== i) {
                    i = e, n(t, e);
                    var o = function(t) {
                        i = null, r(t, e), e.removeEventListener("mouseleave", o)
                    };
        ...
        var c = n(3);
        e.isPrimaryMouseButton = r, e.getEvX = i, e.getEvY = o, e.getEvIsTouch = s, e.preventDefault = a, e.listenBySelector = l, e.listenToHoverBySelector = u;
        var p = ["webkitTransitionEnd", "otransitionend", "oTransitionEnd", "msTransitionEnd", "transitionend"];
        e.whenTransitionDone = d
    }, , function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var r = n(2),
            ...
            o = function(t) {
                ...
                return r.__extends(e, t), e.prototype.listenTo = function(t, e, n) {
                    ...
                    else "string" == typeof e && n && (n = n.bind(this), t.addEventListener ? t.addEventListener(e, n) : t.on(e, n), (this._listeners || (this._listeners = [])).push([t, e, n]))
                }, e.prototype.stopListeningTo = function(t, e) {
                    this._listeners && (this._listeners = this._listeners.filter(function(n) {
                        return !!(n[0] !== t || e && e !== n[1]) || (t.removeEventListener ? t.removeEventListener(n[1], n[2]) : t.off(n[1], n[2]), !1)
                    }))
                }, e
            }(i.default);
        e.default = o
        ...
        function r(t, e) {
            ...
            var n = window.getComputedStyle(t),
                ...
                u = a(t.offsetWidth - t.clientWidth - r - i),
                d = a(t.offsetHeight - t.clientHeight - o - s),
                c = {
                    borderLeft: r,
                    borderRight: i,
                    borderTop: o,
            ...
            return l() && "rtl" === n.direction ? c.scrollbarLeft = u : c.scrollbarRight = u, e && (c.paddingLeft = parseInt(n.paddingLeft, 10) || 0, c.paddingRight = parseInt(n.paddingRight, 10) || 0, c.paddingTop = parseInt(n.paddingTop, 10) || 0, c.paddingBottom = parseInt(n.paddingBottom, 10) || 0), c
        }
        ...
        function o(t) {
            ...
            return t.offsetHeight + parseInt(e.marginTop, 10) + parseInt(e.marginBottom, 10)
        }
        ...
        function u() {
            ...
            var e = t.firstChild,
                n = e.getBoundingClientRect().left > t.getBoundingClientRect().left;
            return d.removeElement(t), n
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var d = n(3);
        e.computeEdges = r, e.computeInnerRect = i, e.computeHeightAndMargins = o, e.getScrollParent = s;
        var c = null
    }, function(t, e, n) {
        function r(t, e) {
        ...
        function i(t, e, n) {
            ...
            var r, i, a, d, c = t[0],
                p = 1 === t.length && "string" == typeof c;
            return o.isMoment(c) || s.isNativeDate(c) || void 0 === c ? d = o.apply(null, t) : (r = !1, i = !1, p ? l.test(c) ? (c += "-01", t = [c], r = !0, i = !0) : (a = u.exec(c)) && (r = !a[5], i = !0) : Array.isArray(c) && (i = !0), d = e || r ? o.utc.apply(o, t) : o.apply(null, t), r ? (d._ambigTime = !0, d._ambigZone = !0) : n && (i ? d._ambigZone = !0 : p && d.utcOffset(c))), d._fullCalendar = !0, d
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        function i(t, e, n) {
            n ? t[e] && (t[e] = t[e].filter(function(t) {
                return t !== n
            })) : delete t[e]
        }
        Object.defineProperty(e, "__esModule", {
        ...
        var o = n(2),
            ...
            l = function(t) {
                ...
                return o.__extends(e, t), e.prototype.on = function(t, e) {
                    return r(this._handlers || (this._handlers = {}), t, e), this
                }, e.prototype.one = function(t, e) {
                    return r(this._oneHandlers || (this._oneHandlers = {}), t, e), this
                }, e.prototype.off = function(t, e) {
                    return this._handlers && i(this._handlers, t, e), this._oneHandlers && i(this._oneHandlers, t, e), this
                }, e.prototype.trigger = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return this.triggerWith(t, this, e), this
                }, e.prototype.triggerWith = function(t, e, n) {
                    return this._handlers && s.applyAll(this._handlers[t], e, n), this._oneHandlers && (s.applyAll(this._oneHandlers[t], e, n), delete this._oneHandlers[t]), this
                }, e.prototype.hasHandlers = function(t) {
                    return this._handlers && this._handlers[t] && this._handlers[t].length || this._oneHandlers && this._oneHandlers[t] && this._oneHandlers[t].length
                }, e
            }(a.default);
        e.default = l
    }, function(t, e) {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.removeMatching = n, e.removeExact = r, e.isArraysEqual = i
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var s = null,
            ...
            l = function() {
                function t() {
                    var t = this;
                    this.isTouching = !1, this.mouseIgnoreDepth = 0, this.handleTouchMove = function(e) {
                        t.isTouching && t.trigger("touchmove", e)
                    }, this.handleScroll = function(e) {
                        t.trigger("scroll", e)
                    }
                }
                return t.get = function() {
                    return s || (s = new t, s.bind()), s
                }, t.needed = function() {
                    t.get(), a++
                }, t.unneeded = function() {
                    a > 0 && (--a || (s.unbind(), s = null))
                    ...
                    this.stopListeningTo(document), window.removeEventListener("touchmove", this.handleTouchMove), window.removeEventListener("scroll", this.handleScroll, !0)
        ...
        e.default = l, o.default.mixInto(l), i.default.mixInto(l)
    }, function(t, e, n) {
        function r(t, n) {
            e.viewHash[t] = n
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.version = "4.0.0-alpha", e.internalApiVersion = 12;
        var r = n(4);
        e.applyAll = r.applyAll, e.debounce = r.debounce, e.isInt = r.isInt, e.capitaliseFirstLetter = r.capitaliseFirstLetter, e.parseFieldSpecs = r.parseFieldSpecs, e.compareByFieldSpecs = r.compareByFieldSpecs, e.compareByFieldSpec = r.compareByFieldSpec, e.flexibleCompare = r.flexibleCompare, e.log = r.log, e.warn = r.warn;
        var i = n(6);
        e.htmlEscape = i.htmlEscape, e.cssToStr = i.cssToStr;
        var o = n(21);
        e.removeExact = o.removeExact;
        var s = n(214);
        e.intersectRects = s.intersectRects;
        var a = n(5);
        e.assignTo = a.assignTo;
        var l = n(8);
        e.computeGreatestUnit = l.computeGreatestUnit, e.divideRangeByDuration = l.divideRangeByDuration, e.divideDurationByDuration = l.divideDurationByDuration, e.multiplyDuration = l.multiplyDuration, e.durationHasTime = l.durationHasTime;
        var u = n(3);
        e.findElements = u.findElements, e.findChildren = u.findChildren, e.htmlToElement = u.htmlToElement, e.createElement = u.createElement,
            e.insertAfterElement = u.insertAfterElement, e.prependToElement = u.prependToElement, e.removeElement = u.removeElement, e.appendToElement = u.appendToElement, e.applyStyle = u.applyStyle, e.applyStyleProp = u.applyStyleProp, e.elementMatches = u.elementMatches, e.forceClassName = u.forceClassName;
        var d = n(10);
        e.preventDefault = d.preventDefault, e.listenBySelector = d.listenBySelector, e.whenTransitionDone = d.whenTransitionDone;
        var c = n(13);
        e.computeInnerRect = c.computeInnerRect, e.computeEdges = c.computeEdges, e.computeHeightAndMargins = c.computeHeightAndMargins;
        var p = n(52);
        e.formatDate = p.formatDate, e.formatRange = p.formatRange, e.queryMostGranularFormatUnit = p.queryMostGranularFormatUnit;
        var h = n(36);
        e.datepickerLocale = h.datepickerLocale, e.locale = h.locale;
        var f = n(14);
        e.moment = f.default;
        var g = n(15);
        e.EmitterMixin = g.default;
        var v = n(12);
        e.ListenerMixin = v.default;
        var y = n(53);
        e.Model = y.default;
        var m = n(215);
        e.Constraints = m.default;
        var b = n(7);
        e.UnzonedRange = b.default;
        var E = n(16);
        e.ComponentFootprint = E.default;
        var w = n(220);
        e.BusinessHourGenerator = w.default;
        var D = n(39);
        e.EventDef = D.default;
        var S = n(42);
        e.EventDefMutation = S.default;
        var C = n(43);
        e.EventSourceParser = C.default;
        var T = n(9);
        e.EventSource = T.default;
        var R = n(56);
        e.defineThemeSystem = R.defineThemeSystem;
        var M = n(23);
        e.EventInstanceGroup = M.default;
        var I = n(57);
        e.ArrayEventSource = I.default;
        var H = n(223);
        e.FuncEventSource = H.default;
        var P = n(224);
        e.JsonFeedEventSource = P.default;
        var _ = n(41);
        ...
        e.Mixin = O.default;
        var L = n(59);
        e.CoordCache = L.default;
        var z = n(60);
        e.DragListener = z.default;
        var F = n(225);
        e.TaskQueue = F.default;
        var B = n(226);
        e.RenderQueue = B.default;
        var A = n(44);
        e.Scroller = A.default;
        var k = n(24);
        e.Theme = k.default;
        var N = n(227);
        e.DateComponent = N.default;
        var V = n(45);
        e.InteractiveDateComponent = V.default;
        var j = n(246);
        e.Calendar = j.default;
        var G = n(46);
        e.View = G.default;
        var U = n(26);
        e.defineView = U.defineView, e.getViewConfig = U.getViewConfig;
        var W = n(61);
        e.DayTableMixin = W.default;
        var q = n(62);
        e.BusinessHourRenderer = q.default;
        var Y = n(47);
        e.EventRenderer = Y.default;
        var Z = n(63);
        e.FillRenderer = Z.default;
        var Q = n(64);
        e.HelperRenderer = Q.default;
        var X = n(229);
        e.ExternalDropping = X.default;
        var $ = n(230);
        e.EventResizing = $.default;
        var K = n(65);
        e.EventPointing = K.default;
        var J = n(231);
        e.EventDragging = J.default;
        var tt = n(232);
        e.DateSelecting = tt.default;
        var et = n(66);
        e.StandardInteractionsMixin = et.default;
        var nt = n(233);
        e.AgendaView = nt.default;
        var rt = n(234);
        e.TimeGrid = rt.default;
        var it = n(67);
        e.DayGrid = it.default;
        var ot = n(68);
        e.BasicView = ot.default;
        var st = n(236);
        e.MonthView = st.default;
        var at = n(237);
        e.ListView = at.default
    }, function(t, e, n) {
        function r(t) {
            for (var e in h) {
                var n = h[e];
        ...
        function i(t, n, r) {
            ...
            i.isRTL = r.isRTL, i.weekNumberTitle = r.weekHeader;
            for (var o in c) {
                var s = c[o];
                i[o] = s(r)
            }
            var a = window.jQuery && window.jQuery.datepicker;
            a && (a.regional[n] = a.regional[t] = r, a.regional.en = a.regional[""], a.setDefaults(r))
        }

        function o(t, n) {
            var r, i;
            r = e.localeOptionHash[t] || (e.localeOptionHash[t] = {}), n && (r = e.localeOptionHash[t] = u.mergeOptions([r, n])), i = s(t);
            for (var o in p) {
                var a = p[o];
                null == r[o] && (r[o] = a(i, r))
            }
            u.globalDefaults.locale = t
        }

        function s(t) {
            return a.localeData(t) || a.localeData("en")
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var a = n(0),
            ...
            u = n(37),
            d = n(6);
        e.localeOptionHash = {}, l.locales = e.localeOptionHash;
        var c = {
                buttonText: function(t) {
                    return {
                        prev: d.stripHtmlEntities(t.prevText),
                        next: d.stripHtmlEntities(t.nextText),
                        today: d.stripHtmlEntities(t.currentText)
                    }
                },
        ...
        e.populateInstanceComputableOptions = r, e.datepickerLocale = i, e.locale = o, e.getMomentLocaleData = s, o("en", u.englishDefaults)
    }, function(t, e, n) {
        function r(t) {
        ...
        var r = n(5),
            ...
            o = function() {
                ...
                return t.parse = function(t, e) {
                    ...
                    return e.id = this.id, e.rawId = this.rawId, e.uid = this.uid, t.copyVerbatimStandardProps(this, e), e.className = this.className.slice(), e.miscProps = r.assignTo({}, this.miscProps), e
                    ...
                    var e = r.assignTo({}, this.miscProps);
                    ...
                    return null != e.id ? this.id = t.normalizeId(this.rawId = e.id) : this.id = t.generateId(), null != e._id ? this.uid = String(e._id) : this.uid = t.generateId(), Array.isArray(e.className) && (this.className = e.className), "string" == typeof e.className && (this.className = e.className.split(/\s+/)), !0
                }, t.prototype.applyMiscProps = function(t) {
                    r.assignTo(this.miscProps, t)
        ...
        var r = n(2),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.prototype.render = function() {
                    ...
                    return this.scrollEl = o.createElement("div", {
                    ...
                    var e = this.scrollEl,
                        n = this.overflowX,
                        r = this.overflowY;
                    t = t || this.getScrollbarWidths(), "auto" === n && (n = t.bottom || e.scrollWidth - 1 > e.clientWidth ? "scroll" : "hidden"), "auto" === r && (r = t.left || t.right || e.scrollHeight - 1 > e.clientHeight ? "scroll" : "hidden"), o.applyStyle(this.scrollEl, {
                        overflowX: n,
                        overflowY: r
                    })
                }, e.prototype.setHeight = function(t) {
                    o.applyStyleProp(this.scrollEl, "height", t)
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.setElement = function(e) {
                    ...
                    t.addEventListener(e, function(t) {
                        if (!o.elementClosest(t.target, r.segSelector + ":not(.fc-helper),.fc-more,a[data-goto]")) return n.call(r, t)
                    })
                    ...
                    s.listenBySelector(t, e, this.segSelector, this.makeSegMouseHandler(n))
                }, e.prototype.bindSegHoverHandlersToEl = function(t, e, n) {
                    s.listenToHoverBySelector(t, this.segSelector, this.makeSegMouseHandler(e), this.makeSegMouseHandler(n))
                }, e.prototype.makeSegMouseHandler = function(t) {
                    var e = this;
                    return function(n, r) {
                        if (!r.classList.contains("fc-helper")) {
                            var i = r.fcSeg;
                            if (i && !e.shouldIgnoreEventPointing()) return t.call(e, i, n)
                        }
                    }
                    ...
                    return (!s.getEvIsTouch(e) || n.isEventDefSelected(r)) && this.isEventDefResizable(r) && e.target.classList.contains("fc-resizer")
                ...
                }, e.prototype.handlExternalDragStart = function(e, n, r) {
                    this.externalDropping && this.externalDropping.handleDragStart(e, n, r), t.prototype.handlExternalDragStart.call(this, e, n, r)
                }, e.prototype.handleExternalDragMove = function(e) {
                    this.externalDropping && this.externalDropping.handleDragMove(e), t.prototype.handleExternalDragMove.call(this, e)
                }, e.prototype.handleExternalDragStop = function(e) {
                    this.externalDropping && this.externalDropping.handleDragStop(e), t.prototype.handleExternalDragStop.call(this, e)
                    ...
                    return this.largeUnit ? i.diffByUnit(t, e, this.largeUnit) : i.diffDayTime(t, e)
        ...
        var r = n(2),
            ...
            f = function(t) {
                function e(e, n) {
                    ...
                    return r.batchRenderDepth = 0, r.isSelected = !1, r.calendar = e, r.viewSpec = n, r.type = n.type, r.name = r.type, r.initRenderQueue(), r.initHiddenDays(), r.dateProfileGenerator = new r.dateProfileGeneratorClass(r), r.bindBaseRenderHandlers(), r.eventOrderSpecs = l.parseFieldSpecs(r.opt("eventOrder")), r.initialize && r.initialize(), r
                }
                return r.__extends(e, t), e.prototype._getView = function() {
                    ...
                    this.renderQueue = new u.default({
                ...
                }, e.prototype.fetchInitialEvents = function(t, e) {
                    var n = this.calendar,
                        r = t.isRangeAllDay && !this.usesMinMaxTime;
                    n.requestEvents(n.msToMoment(t.activeUnzonedRange.startMs, r), n.msToMoment(t.activeUnzonedRange.endMs, r), e)
                    ...
                    t.prototype.bindGlobalHandlers.call(this), this.listenTo(p.default.get(), {
                        touchstart: this.processUnselect,
                        mousedown: this.handleDocumentMousedown
                    })
                }, e.prototype.unbindGlobalHandlers = function() {
                    t.prototype.unbindGlobalHandlers.call(this), this.stopListeningTo(p.default.get())
                }, e.prototype.startNowIndicator = function() {
                    var t, e, n, r = this;
                    this.opt("nowIndicator") && (t = this.getNowIndicatorUnit()) && (e = this.updateNowIndicator.bind(this), this.initialNowDate = this.calendar.getNow(), this.initialNowQueriedMs = (new Date).valueOf(), n = this.initialNowDate.clone().startOf(t).add(1, t).valueOf() - this.initialNowDate.valueOf(), this.nowIndicatorTimeoutID = setTimeout(function() {
                        r.nowIndicatorTimeoutID = null, e(), n = +i.duration(1, t), n = Math.max(100, n), r.nowIndicatorIntervalID = setInterval(e, n)
                    }, n))
                    ...
                    var t = {};
                    return this.isDatesRendered && o.assignTo(t, this.queryDateScroll()), t
                }, e.prototype.applyScroll = function(t) {
                    t.isDateInit && this.isDatesRendered && o.assignTo(t, this.computeInitialDateScroll()), this.isDatesRendered && this.applyDateScroll(t)
                    ...
                    var o = this.calendar.eventManager,
                        s = o.mutateEventsWithId(t.def.id, e),
                        a = e.dateMutation;
                    a && (t.dateProfile = a.buildNewDateProfile(t.dateProfile, this.calendar)), this.triggerEventDrop(t, a && a.dateDelta || i.duration(), s, n, r)
                }, e.prototype.triggerEventDrop = function(t, e, n, r, i) {
                    this.publiclyTrigger("eventDrop", {
                        context: r,
                        args: [t.toLegacy(), e, n, i, {}, this]
                    })
                }, e.prototype.reportExternalDrop = function(t, e, n, r, i) {
                    e && this.calendar.eventManager.addEventDef(t, n), this.triggerExternalDrop(t, e, r, i)
                }, e.prototype.triggerExternalDrop = function(t, e, n, r) {
                    this.publiclyTrigger("drop", {
                        context: n,
                        args: [t.dateProfile.start.clone(), r, this]
                    ...
                    this.selectedEventInstance && this.selectedEventInstance === t || (this.unselectEventInstance(), this.getEventSegs().forEach(function(e) {
                        e.footprint.eventInstance === t && e.el && e.el.classList.add("fc-selected")
                    ...
                    this.selectedEventInstance && (this.getEventSegs().forEach(function(t) {
                        t.el && t.el.classList.remove("fc-selected")
                    ...
                    var e;
                    this.isSelected && this.opt("unselectAuto") && ((e = this.opt("unselectCancel")) && s.elementClosest(t.target, e) || this.unselect(t))
                }, e.prototype.processEventUnselect = function(t) {
                    this.selectedEventInstance && (s.elementClosest(t.target, ".fc-selected") || this.unselectEventInstance())
                    ...
                    var t, e = this.opt("hiddenDays") || [],
                        n = [],
                        r = 0;
                    for (!1 === this.opt("weekends") && e.push(0, 6), t = 0; t < 7; t++)(n[t] = -1 !== e.indexOf(t)) || r++;
                    ...
                    return i.isMoment(t) && (t = t.day()), this.isHiddenDayHash[t]
        ...
        e.default = f, f.prototype.usesMinMaxTime = !1, f.prototype.dateProfileGeneratorClass = d.default, f.watch("displayingDates", ["isInDom", "dateProfile"], function(t) {
            this.requestDateRender(t.dateProfile)
        }, function() {
            this.requestDateUnrender()
        }), f.watch("displayingBusinessHours", ["displayingDates", "businessHourGenerator"], function(t) {
            this.requestBusinessHoursRender(t.businessHourGenerator)
        }, function() {
            this.requestBusinessHoursUnrender()
        }), f.watch("initialEvents", ["dateProfile"], function(t, e) {
            this.fetchInitialEvents(t.dateProfile, e)
        }, null, !0), f.watch("bindingEvents", ["initialEvents"], function(t) {
            this.setEvents(t.initialEvents), this.bindEventChanges()
        }, function() {
            this.unbindEventChanges(), this.unsetEvents()
        }), f.watch("displayingEvents", ["displayingDates", "hasEvents"], function() {
            this.requestEventsRender(this.get("currentEvents"))
        }, function() {
            this.requestEventsUnrender()
        }), f.watch("title", ["dateProfile"], function(t) {
            return this.title = this.computeTitle(t.dateProfile)
        }), f.watch("legacyDateProps", ["dateProfile"], function(t) {
            var e = this.calendar,
                n = t.dateProfile;
            ...
            o = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    if (t.length) {
                        ...
                        r.htmlToElements(s).forEach(function(e, r) {
                            var i = t[r];
                            o && (e = n.filterEventRenderEl(i.footprint, e)), e && (e.fcSeg = i, i.el = e, a.push(i))
                        })
                    }
                    return a
                    ...
                    t.sort(this.compareEventSegs.bind(this))
        ...
        function c(t) {
            var e, n, r = [];
            for (e = 0; e < t.length; e++) n = t[e], "string" == typeof n ? r.push("[" + n + "]") : n.token ? n.token in D ? r.push(b + "[" + n.token + "]") : r.push(n.token) : n.maybe && r.push(E + c(n.maybe) + E);
            return r.join(m)
        }
        ...
        function f(t, e) {
            var n, r, i = [],
                ...
                s = o.split(m);
            for (n = 0; n < s.length; n++) r = s[n], r.charAt(0) === b ? i.push(D[r.substring(1)](e)) : i.push(r);
            return i
        }
        ...
        var r = n(2),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.watch = function(t) {
                    ...
                    var e, n, r = {},
                        i = 0;
                    for (e in t)("object" == typeof(n = t[e]) && n || n !== this._props[e]) && (r[e] = n, i++);
                    if (i) {
                ...
                }, e.prototype.watch = function(t, e, n, r, i) {
                    var o = this;
                    void 0 === i && (i = !1), this.unwatch(t), this._watchers[t] = this._watchDeps(e, function(e) {
                        if (i) o.unset(t), n.call(o, e, function(e) {
                            o.set(t, e)
                        });
                        else {
                            var r = n.call(o, e);
        ...
        var r = n(2),
            ...
            a = function(t) {
                ...
                return r.__extends(e, t), e.parse = function(t, e) {
                    var n;
                    return Array.isArray(t.events) ? n = t : Array.isArray(t) && (n = {
                        events: t
                ...
                }, e.prototype.fetch = function(t, e, n, r, i) {
                    var o, a = this.eventDefs;
                    if (null != this.currentTimezone && this.currentTimezone !== n)
                        for (o = 0; o < a.length; o++) a[o] instanceof s.default && a[o].rezone();
                    this.currentTimezone = n, r(a)
                }, e.prototype.addEventDef = function(t) {
                    this.eventDefs.push(t)
                }, e.prototype.removeEventDefsById = function(t) {
                    return i.removeMatching(this.eventDefs, function(e) {
                        return e.id === t
                    })
        ...
        var r = n(13),
            i = function() {
                function t(t) {
                    this.isHorizontal = !1, this.isVertical = !1, this.els = t.els, this.isHorizontal = t.isHorizontal, this.isVertical = t.isVertical, this.forcedOffsetParentEl = t.offsetParent
                }
                return t.prototype.build = function() {
                    var t = this.forcedOffsetParentEl;
                    if (!t && this.els.length > 0 && (t = this.els[0].offsetParent), t) {
                        var e = t.getBoundingClientRect();
                        this.origin = {
                            top: e.top,
                            left: e.left
                        }, this.boundingRect = this.queryBoundingRect(), this.isHorizontal && this.buildElHorizontals(), this.isVertical && this.buildElVerticals()
                    } else this.lefts = [], this.rights = [], this.tops = [], this.bottoms = []
                    ...
                    var t;
                    return this.els.length > 0 && (t = r.getScrollParent(this.els[0])) ? r.computeInnerRect(t) : null
        ...
        var r = n(13),
            ...
            l = function() {
                function t(t) {
                    this.isInteracting = !1, this.isDistanceSurpassed = !1, this.isDelayEnded = !1, this.isDragging = !1, this.isTouch = !1, this.skipBinding = !1, this.shouldCancelTouchScroll = !0, this.scrollAlwaysKills = !1, this.isAutoScroll = !1, this.scrollSensitivity = 30, this.scrollSpeed = 200, this.scrollIntervalMs = 50, this.options = t || {}
                }
                return t.prototype.startInteraction = function(t, e) {
                    if (void 0 === e && (e = {}), "mousedown" === t.type) {
                        if (a.default.get().shouldIgnoreMouse()) return;
                    ...
                    this.isInteracting && (this.endDrag(t), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null), this.destroyAutoScroll(), this.unbindHandlers(), this.isInteracting = !1, this.handleInteractionEnd(t, e), o.allowSelection(document.body))
                }, t.prototype.handleInteractionEnd = function(t, e) {
                    this.trigger("interactionEnd", t, e || !1)
                }, t.prototype.bindHandlers = function() {
                    var t = a.default.get();
                    this.skipBinding || (this.isTouch ? this.listenTo(t, {
                    ...
                    this.stopListeningTo(a.default.get())
                    ...
                    var t = this.scrollEl;
                    this.isAutoScroll = Boolean(this.options.scroll && t), this.isAutoScroll && this.listenTo(t, "scroll", o.debounce(this.handleDebouncedScroll, 100))
                }, t.prototype.destroyAutoScroll = function() {
                    this.endAutoScroll(), this.isAutoScroll && this.stopListeningTo(this.scrollEl, "scroll")
                }, t.prototype.computeScrollBounds = function() {
                    this.isAutoScroll && (this.scrollBounds = this.scrollEl.getBoundingClientRect())
                    ...
                    this.scrollTopVel = t, this.scrollLeftVel = e, this.constrainScrollVel(), !this.scrollTopVel && !this.scrollLeftVel || this.scrollIntervalId || (this.scrollIntervalId = setInterval(this.scrollIntervalFunc.bind(this), this.scrollIntervalMs))
                }, t.prototype.constrainScrollVel = function() {
                    var t = this.scrollEl;
                    this.scrollTopVel < 0 ? t.scrollTop <= 0 && (this.scrollTopVel = 0) : this.scrollTopVel > 0 && t.scrollTop + t.clientHeight >= t.scrollHeight && (this.scrollTopVel = 0), this.scrollLeftVel < 0 ? t.scrollLeft <= 0 && (this.scrollLeftVel = 0) : this.scrollLeftVel > 0 && t.scrollLeft + t.clientWidth >= t.scrollWidth && (this.scrollLeftVel = 0)
        ...
        var r = n(2),
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    var r, s = this,
                        a = s.view,
                        l = s.dateProfile.activeUnzonedRange.containsDate(t),
                        u = ["fc-day-header", a.calendar.theme.getClass("widgetHeader")];
                    return r = "function" == typeof s.opt("columnHeaderHtml") ? s.opt("columnHeaderHtml")(t) : "function" == typeof s.opt("columnHeaderText") ? i.htmlEscape(s.opt("columnHeaderText")(t)) : i.htmlEscape(t.format(s.colHeadFormat)), 1 === s.rowCnt ? u = u.concat(s.getDayClasses(t, !0)) : u.push("fc-" + o.dayIDs[t.day()]), '<th class="' + u.join(" ") + '"' + (1 === (l && s.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + (l ? a.buildGotoAnchorHtml({
                        date: t,
                        forceOff: s.rowCnt > 1 || 1 === s.colCnt
                    }, r) : r) + "</th>"
                    ...
                    e && (this.isRTL ? s.appendToElement(t, e) : s.prependToElement(t, e))
                }, e
            }(a.default);
        e.default = l
    }, function(t, e) {
        ...
        var r = n(6),
            ...
            o = function() {
                ...
                return t.prototype.renderFootprint = function(t, e, n) {
                    ...
                    e && (e.forEach(i.removeElement), delete this.elsByFill[t])
                    ...
                    if (e.length) {
                        ...
                        i.htmlToElements(s).forEach(function(t, r) {
                            var s = e[r];
                            n.filterEl && (t = n.filterEl(s, t)), t && i.elementMatches(t, o.fillSegTag) && (s.el = t, a.push(s))
                        })
                    }
                    return a
                    ...
                    return "<" + this.fillSegTag + (i.length ? ' class="' + i.join(" ") + '"' : "") + (o ? ' style="' + o + '"' : "") + "></" + this.fillSegTag + ">"
                }, t.prototype.attachSegEls = function(t, e) {}, t.prototype.reportEls = function(t, e) {
                    (n = this.elsByFill[t] || (this.elsByFill[t] = [])).push.apply(n, e);
                    var n
                }, t
            }();
        e.default = o
            ...
            a = function() {
                ...
                return t.prototype.renderComponentFootprint = function(t) {
                    ...
                    for (o = this.eventRenderer.renderFgSegEls(o), i = 0; i < o.length; i++) {
                        var s = o[i].el.classList;
                        s.add("fc-helper"), n && s.add(n)
                    }
                    if (null != r)
                        for (i = 0; i < o.length; i++) o[i].el.style.opacity = r;
                    this.helperEls = this.renderSegs(o, e)
                }, t.prototype.unrender = function() {
                    this.helperEls && (this.helperEls.forEach(r.removeElement), this.helperEls = null)
                }, t.prototype.fabricateEventFootprint = function(t) {
                    var e, n = this.view.calendar,
                        r = n.footprintToDateProfile(t),
                        a = new i.default(new s.default(n));
                    return a.dateProfile = r, e = a.buildInstance(), new o.default(t, a, e)
                }, t
            }();
        e.default = a
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.bindToEl = function(t) {
                    var e = this.component;
                    e.bindSegHandlerToEl(t, "click", this.handleClick.bind(this)), e.bindSegHoverHandlersToEl(t, this.handleMouseover.bind(this), this.handleMouseout.bind(this))
                    ...
                    i.default.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t, this.view.isEventDefResizable(t.footprint.eventDef) && t.el.classList.add("fc-allow-mouse-resize"), this.component.publiclyTrigger("eventMouseover", {
                        context: t.el,
                        args: [t.footprint.getEventLegacy(), e, this.view]
                    }))
                }, e.prototype.handleMouseout = function(t, e) {
                    this.mousedOverSeg && (this.mousedOverSeg = null, this.view.isEventDefResizable(t.footprint.eventDef) && t.el.classList.remove("fc-allow-mouse-resize"), this.component.publiclyTrigger("eventMouseout", {
                        context: t.el,
                        args: [t.footprint.getEventLegacy(), e || {}, this.view]
                    }))
        ...
        var r = n(2),
            ...
            b = function(t) {
                ...
                return r.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    for (var e = this.sliceRangeByRow(t.unzonedRange), n = 0; n < e.length; n++) {
                        var r = e[n];
                        this.isRTL ? (r.leftCol = this.daysPerRow - 1 - r.lastRowDayIndex, r.rightCol = this.daysPerRow - 1 - r.firstRowDayIndex) : (r.leftCol = r.firstRowDayIndex, r.rightCol = r.lastRowDayIndex)
                    }
                    return e
                    ...
                    var t, e, n = this.view,
                        ...
                        i = this.colCnt,
                        o = "";
                    for (this.headContainerEl && (this.headContainerEl.innerHTML = this.renderHeadHtml()), t = 0; t < r; t++) o += this.renderDayRowHtml(t, this.isRigid);
                    for (this.el.innerHTML = o, this.rowEls = s.findElements(this.el, ".fc-row"), this.cellEls = s.findElements(this.el, ".fc-day, .fc-disabled-day"), this.rowCoordCache = new a.default({
                            els: this.rowEls,
                            isVertical: !0
                        }), this.colCoordCache = new a.default({
                    ...
                    return new d.default(new u.default(e.start, e.end), !0)
                    ...
                    var e, n, r = this.rowEls[t],
                        i = r.getBoundingClientRect().bottom,
                        o = s.findChildren(this.eventRenderer.rowStructs[t].tbodyEl);
                    for (e = 0; e < o.length; e++)
                        if (n = o[e], n.classList.remove("fc-limited"), n.getBoundingClientRect().bottom > i) return e;
                    return !1
                }, e.prototype.limitRow = function(t, e) {
                    var n, r, i, o, a, l, u, d, c, p, h, f, g, v, y, m = this,
                        b = this.eventRenderer.rowStructs[t],
                        E = [],
                        w = 0,
                        D = function(n) {
                            for (; w < n;) l = m.getCellSegs(t, w, e), l.length && (c = r[e - 1][w], y = m.renderMoreLink(t, w, l), v = s.createElement("div", null, y), c.appendChild(v), E.push(v[0])), w++
                        };
                    if (e && e < b.segLevels.length) {
                        for (n = b.segLevels[e - 1], r = b.cellMatrix, i = s.findChildren(b.tbodyEl).slice(e), i.forEach(function(t) {
                                t.classList.add("fc-limited")
                            }), o = 0; o < n.length; o++) {
                            for (a = n[o], D(a.leftCol), d = [], u = 0; w <= a.rightCol;) l = this.getCellSegs(t, w, e), d.push(l), u += l.length, w++;
                            if (u) {
                                for (c = r[e - 1][a.leftCol], p = c.rowSpan || 1, h = [], f = 0; f < d.length; f++) g = s.createElement("td", {
                                    className: "fc-more-cell",
                                    rowSpan: p
                                }), l = d[f], y = this.renderMoreLink(t, a.leftCol + f, [a].concat(l)), v = s.createElement("div", null, y), g.appendChild(v), h.push(g), E.push(g);
                                c.classList.add("fc-limited"), s.insertAfterElement(c, h), i.push(c)
                            }
                        }
                        D(this.colCnt), b.moreEls = E, b.limitedEls = i
                    }
                }, e.prototype.unlimitRow = function(t) {
                    var e = this.eventRenderer.rowStructs[t];
                    e.moreEls && (e.moreEls.forEach(s.removeElement), e.moreEls = null), e.limitedEls && (e.limitedEls.forEach(function(t) {
                    ...
                    return o.innerText = this.getMoreLinkText(n.length), o.addEventListener("click", function(o) {
                        var s = r.opt("eventLimitClick"),
                            a = r.getCellDate(t, e),
                            l = o.currentTarget,
                            u = r.getCellEl(t, e),
                            d = r.getCellSegs(t, e),
                            c = r.resliceDaySegs(d, a),
                            p = r.resliceDaySegs(n, a);
                        "function" == typeof s && (s = r.publiclyTrigger("eventLimitClick", {
                            context: i,
                            args: [{
                                date: a.clone(),
                                dayEl: u,
                        ...
                        })), "popover" === s ? r.showSegPopover(t, e, l, c) : "string" == typeof s && i.calendar.zoomTo(a, s)
                    }), o
                }, e.prototype.showSegPopover = function(t, e, n, r) {
                    var i, o, s = this,
                        a = this.view,
                        u = n.parentNode;
                    i = 1 === this.rowCnt ? a.el : this.rowEls[t], o = {
                    ...
                    }, this.isRTL ? o.right = u.getBoundingClientRect().right + 1 : o.left = u.getBoundingClientRect().left - 1, this.segPopover = new l.default(o), this.segPopover.show(), this.bindAllSegHandlersToEl(this.segPopover.el), this.triggerAfterEventSegsRendered(r)
                }, e.prototype.renderSegPopoverContent = function(t, e, n) {
                    var r, i = this.view,
                        a = i.calendar.theme,
                        l = this.getCellDate(t, e).format(this.opt("dayPopoverFormat")),
                        u = s.htmlToElements('<div class="fc-header ' + a.getClass("popoverHeader") + '"><span class="fc-close ' + a.getIconClass("close") + '"></span><span class="fc-title">' + o.htmlEscape(l) + '</span><div class="fc-clear"></div></div><div class="fc-body ' + a.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>'),
                        d = u[1].querySelector(".fc-event-container");
                    for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, r = 0; r < n.length; r++) this.hitsNeeded(), n[r].hit = this.getCellHit(t, e), this.hitsNotNeeded(), d.appendChild(n[r].el);
                    return u
                    ...
                    var n, r, o, s = e.clone(),
                        ...
                        l = new u.default(s, a),
                        p = [];
                    for (n = 0; n < t.length; n++) r = t[n], (o = r.footprint.componentFootprint.unzonedRange.intersect(l)) && p.push(i.assignTo({}, r, {
                        footprint: new c.default(new d.default(o, r.footprint.componentFootprint.isAllDay), r.footprint.eventDef, r.footprint.eventInstance),
        ...
        e.default = b, b.prototype.eventRendererClass = v.default, b.prototype.businessHourRendererClass = p.default, b.prototype.helperRendererClass = y.default, b.prototype.fillRendererClass = m.default, h.default.mixInto(b), g.default.mixInto(b)
    }, function(t, e, n) {
        function r(t) {
            return function(t) {
                function e() {
                ...
                return i.__extends(e, t), e.prototype.renderHeadIntroHtml = function() {
                    var t = this.view;
                    return t.colWeekNumbersVisible ? '<th class="fc-week-number ' + t.calendar.theme.getClass("widgetHeader") + '" ' + t.weekNumberStyleAttr() + "><span>" + o.htmlEscape(this.opt("weekNumberTitle")) + "</span></th>" : ""
                }, e.prototype.renderNumberIntroHtml = function(t) {
                    var e = this.view,
                    ...
                    var t = this.view;
                    return c.default.prototype.getIsNumbersVisible.apply(this, arguments) || t.colWeekNumbersVisible
                }, e
            }(t)
        }
        Object.defineProperty(e, "__esModule", {
        ...
        var i = n(2),
            ...
            p = function(t) {
                function e(e, n) {
                    var r = t.call(this, e, n) || this;
                    return r.colWeekNumbersVisible = !1, r.dayGrid = r.instantiateDayGrid(), r.dayGrid.isRigid = r.hasRigidRows(), r.opt("weekNumbers") && (r.opt("weekNumbersWithinDays") ? (r.dayGrid.cellWeekNumbersVisible = !0, r.colWeekNumbersVisible = !1) : (r.dayGrid.cellWeekNumbersVisible = !1, r.colWeekNumbersVisible = !0)), r.addChild(r.dayGrid), r.scroller = new l.default({
                        overflowX: "hidden",
                        overflowY: "auto"
                    }), r
                }
                return i.__extends(e, t), e.prototype.instantiateDayGrid = function() {
                    ...
                    var t, e;
                    this.el.classList.add("fc-basic-view"), this.el.innerHTML = this.renderSkeletonHtml(), this.scroller.render(), t = this.scroller.el, t.classList.add("fc-day-grid-container"), e = s.createElement("div", {
                        className: "fc-day-grid"
                    }), t.appendChild(e), this.el.querySelector(".fc-body > tr > td").appendChild(t), this.dayGrid.headContainerEl = this.el.querySelector(".fc-head-container"), this.dayGrid.setElement(e)
        ...
        e.default = p, p.prototype.dateProfileGeneratorClass = d.default, p.prototype.dayGridClass = c.default
    }, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e) {
        function n(t, e) {
            var n = {
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.intersectRects = n, e.constrainPoint = r, e.getRectCenter = i, e.diffPoints = o
    }, function(t, e, n) {
        function r(t, e, n) {
            var r;
        ...
        var o = n(7),
            ...
            d = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var n;
                    return "businessHours" === t ? this.buildCurrentBusinessFootprints(e) : "object" == typeof t && t ? (n = this.parseEventDefToInstances(t), n ? this.eventInstancesToFootprints(n) : this.parseFootprints(t)) : null != t ? (n = this.eventManager.getEventInstancesWithId(t), this.eventInstancesToFootprints(n)) : void 0
        ...
        var r = n(2),
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.isAllDay = function() {
                    ...
                    var e = t.prototype.clone.call(this);
                    return e.startTime && (e.startTime = i.duration(this.startTime)), e.endTime && (e.endTime = i.duration(this.endTime)), this.dowHash && (e.dowHash = o.assignTo({}, this.dowHash)), e
                }, e
            }(s.default);
        e.default = u, u.prototype.applyProps = function(t) {
            var e = s.default.prototype.applyProps.call(this, t);
            return t.start && (this.startTime = i.duration(t.start)), t.end && (this.endTime = i.duration(t.end)), t.dow && this.setDow(t.dow), e
            ...
            u = function() {
                ...
                return t.prototype.buildEventInstanceGroup = function(t, e) {
                    ...
                    var e, n = this.rawComplexDef,
                        ...
                        i = !1,
                        o = [];
                    for (!0 === n ? r = [{}] : Array.isArray(n) ? (r = n, i = !0) : "object" == typeof n && n && (r = [n]), e = 0; e < r.length; e++) i && !r[e].dow || o.push(this.buildEventDef(t, r[e]));
                    return o
                }, t.prototype.buildEventDef = function(t, e) {
                    var n = r.assignTo({}, l, e);
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.parse = function(t, e) {
                    var n;
                    return "function" == typeof t.events ? n = t : "function" == typeof t && (n = {
                        events: t
                    }), !!n && o.default.parse.call(this, n, e)
                }, e.prototype.fetch = function(t, e, n, r, o) {
                    var s = this;
                    this.calendar.pushLoading(), i.unpromisify(this.func.bind(this.calendar, t.clone(), e.clone(), n), function(t) {
                        s.calendar.popLoading(), r(s.parseEventDefs(t))
                    }, function() {
                        s.calendar.popLoading(), o()
                    })
                }, e.prototype.getPrimitive = function() {
                    return this.func
                }, e.prototype.applyManualStandardProps = function(e) {
        ...
        var r = n(2),
            ...
            l = function(t) {
                ...
                return r.__extends(e, t), e.parse = function(t, e) {
                    ...
                    var a, l = this,
                        u = this.ajaxSettings,
                        d = this.buildRequestParams(t, e, n);
                    this.calendar.pushLoading(), a = u.method && "GET" !== u.method.toUpperCase() ? i(u.method, this.url).send(d) : i.get(this.url).query(d), a.end(function(t, e) {
                        var n;
                        if (l.calendar.popLoading(), t || (e.body ? n = e.body : e.text && (n = JSON.parse(e.text))), n) {
                            var i = s.applyAll(u.success, null, [n, e]);
                            Array.isArray(i) && (n = i), r(l.parseEventDefs(n))
                        } else s.applyAll(u.error, null, [t, e]), o()
                    })
                }, e.prototype.buildRequestParams = function(t, e, n) {
                    var r, i, s, a, l = this.calendar,
                        u = this.ajaxSettings,
                        d = {};
                    return r = this.startParam, null == r && (r = l.opt("startParam")), i = this.endParam, null == i && (i = l.opt("endParam")), s = this.timezoneParam, null == s && (s = l.opt("timezoneParam")), a = "function" == typeof u.data ? u.data() : u.data || {}, o.assignTo(d, a), d[r] = t.format(), d[i] = e.format(), n && "local" !== n && (d[s] = n), d
                }, e.prototype.getPrimitive = function() {
                    return this.url
            ...
            p = function(t) {
                ...
                return i.__extends(e, t), e.prototype.addChild = function(t) {
                    ...
                    this.getEventSegs().forEach(function(e) {
                        e.footprint.eventDef.id === t && e.el && (e.el.style.visibility = "")
                    }), this.callChildren("showEventsWithId", arguments)
                }, e.prototype.hideEventsWithId = function(t) {
                    this.getEventSegs().forEach(function(e) {
                        e.footprint.eventDef.id === t && e.el && (e.el.style.visibility = "hidden")
                ...
                }, e.prototype.handlExternalDragStart = function(t, e, n) {
                    this.callChildren("handlExternalDragStart", arguments)
                }, e.prototype.handleExternalDragMove = function(t) {
                    this.callChildren("handleExternalDragMove", arguments)
                }, e.prototype.handleExternalDragStop = function(t) {
                ...
                }, e.prototype.getHitFootprint = function(t) {}, e.prototype.getHitEl = function(t) {
                    return null
                    ...
                    var r, i, a, u;
                    return o.isMoment(t) || "object" != typeof t ? r = t : (r = t.date, i = t.type, a = t.forceOff), r = l.default(r), u = {
                        date: r.format("YYYY-MM-DD"),
                        type: i || "day"
                    }, "string" == typeof e && (n = e, e = null), e = e ? " " + s.attrsToStr(e) : "", n = n || "", !a && this.opt("navLinks") ? "<a" + e + ' data-goto="' + s.htmlEscape(JSON.stringify(u)) + '">' + n + "</a>" : "<span" + e + ">" + n + "</span>"
        ...
        var r = n(2),
            ...
            f = function(t) {
                ...
                return r.__extends(e, t), e.getDraggedElMeta = function(t) {
                    var n, r, o, s;
                    return n = e.getEmbeddedElData(t, "event", !0), n && ("object" != typeof n && (n = {}), r = n.start, null == r && (r = n.time), o = n.duration, s = n.stick, delete n.start, delete n.time, delete n.duration, delete n.stick), null == r && (r = e.getEmbeddedElData(t, "start")), null == r && (r = e.getEmbeddedElData(t, "time")), null == o && (o = e.getEmbeddedElData(t, "duration")), null == s && (s = e.getEmbeddedElData(t, "stick", !0)), r = null != r ? i.duration(r) : null, o = null != o ? i.duration(o) : null, s = Boolean(s), {
                        eventProps: n,
                        startTime: r,
                        duration: o,
                        stick: s
                    }
                }, e.getEmbeddedElData = function(t, n, r) {
                    void 0 === r && (r = !1);
                    var i = e.dataAttrPrefix,
                        o = (i ? i + "-" : "") + n,
                        s = t.getAttribute("data-" + o) || null;
                    return s && r && (s = JSON.parse(s)), s
                }, e.prototype.end = function() {
                    this.dragListener && this.dragListener.endInteraction()
                }, e.prototype.handleDragStart = function(t, e, n) {
                    var r;
                    this.opt("droppable") && (r = this.opt("dropAccept"), ("function" == typeof r ? r.call(e, e) : s.elementMatches(e, r)) && (this.isDragging || this.listenToExternalDrag(t, e, n)))
                }, e.prototype.handleDragMove = function(t) {
                    this.dragListener && this.dragListener.handleMove(t)
                }, e.prototype.handleDragStop = function(t) {
                    this.dragListener && this.dragListener.endInteraction(t)
                }, e.prototype.listenToExternalDrag = function(t, n, r) {
                    var i, o = this,
                        s = this.component,
                        l = this.view,
                        d = e.getDraggedElMeta(n),
                        p = this.dragListener = new u.default(s, {
                            ...
                            hitOver: function(t) {
                                ...
                                r ? (i = o.computeExternalDrop(r, d), i ? (e = new c.default(i.buildInstances()), n = d.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e)) : n = !1) : n = !1, n || (i = null, a.disableCursor()), i && s.renderDrag(s.eventRangesToEventFootprints(e.sliceRenderRanges(s.dateProfile.renderUnzonedRange, l.calendar)))
                            },
                            hitOut: function() {
                                i = null
                            },
                            hitDone: function() {
                                a.enableCursor(), s.unrenderDrag()
                            },
                            interactionEnd: function(t) {
                                i && l.reportExternalDrop(i, Boolean(d.eventProps), Boolean(d.stick), n, t), o.isDragging = !1, o.dragListener = null
                            }
                        });
                    p.skipBinding = r, p.startDrag(t)
                }, e.prototype.computeExternalDrop = function(t, e) {
                    var n, r = this.view.calendar,
                        i = l.default.utc(t.unzonedRange.startMs).stripZone();
                    return t.isAllDay && (e.startTime ? i.time(e.startTime) : i.stripTime()), e.duration && (n = i.clone().add(e.duration)), i = r.applyTimezone(i), n && (n = r.applyTimezone(n)), d.default.parse(o.assignTo({}, e.eventProps, {
                        start: i,
                        end: n
                    }), new p.default(r))
                }, e.dataAttrPrefix = "", e
        ...
        var r = n(2),
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.end = function() {
                    ...
                    this.component.canStartResize(t, e) && this.buildDragListener(t, e.target.classList.contains("fc-start-resizer")).startInteraction(e, {
                        distance: 5
                    })
                    ...
                    return this.dragListener = new a.default(s, {
                        ...
                        dragStart: function(e) {
                            n = !0, o.eventPointing.handleMouseout(t, e), o.segResizeStart(t, e)
                        },
                        hitOver: function(n, a, c) {
                            var h, f = !0,
                                g = s.getSafeHitFootprint(c),
                                v = s.getSafeHitFootprint(n);
                            g && v ? (r = e ? o.computeEventStartResizeMutation(g, v, t.footprint) : o.computeEventEndResizeMutation(g, v, t.footprint), r ? (h = d.buildMutatedEventInstanceGroup(p.id, r), f = s.isEventInstanceGroupAllowed(h)) : f = !1) : f = !1, f ? r.isEmpty() && (r = null) : (r = null, i.disableCursor()), r && (l.hideEventsWithId(t.footprint.eventDef.id), l.renderEventResize(s.eventRangesToEventFootprints(h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u)), t))
                        },
                        hitOut: function() {
                            r = null
                        },
                        hitDone: function() {
                            l.unrenderEventResize(t), l.showEventsWithId(t.footprint.eventDef.id), i.enableCursor()
                        },
                        interactionEnd: function(e) {
                            n && o.segResizeStop(t, e), r && l.reportEventResize(h, r, c, e), o.dragListener = null
                        }
                    })
                    ...
                    var r, i, a = n.componentFootprint.unzonedRange,
                        l = this.component.diffDates(e.unzonedRange.getStart(), t.unzonedRange.getStart());
                    return a.getStart().add(l) < a.getEnd() && (r = new s.default, r.setStartDelta(l), i = new o.default, i.setDateMutation(r), i)
                    ...
                    return a.getEnd().add(l) > a.getStart() && (r = new s.default, r.setEndDelta(l), i = new o.default, i.setDateMutation(r), i)
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
        ...
        var i, o, s = n(2),
            ...
            v = function(t) {
                function e(e, n) {
                    var r = t.call(this, e, n) || this;
                    return r.usesMinMaxTime = !0, r.timeGrid = r.instantiateTimeGrid(), r.addChild(r.timeGrid), r.opt("allDaySlot") && (r.dayGrid = r.instantiateDayGrid(), r.addChild(r.dayGrid)), r.scroller = new p.default({
                        overflowX: "hidden",
                        overflowY: "auto"
                    }), r
                }
                return s.__extends(e, t), e.prototype.instantiateTimeGrid = function() {
                    ...
                    var i, o, s, a = this;
                    if (t.prototype.updateSize.call(this, e, n, r), this.axisWidth = c.matchCellWidths(d.findElements(this.el, ".fc-axis")), !this.timeGrid.colEls) return void(n || (o = this.computeScrollerHeight(e), this.scroller.setHeight(o)));
                    var l = d.findElements(this.el, ".fc-row").filter(function(t) {
                        return !a.scroller.el.contains(t)
                    });
                    this.timeGrid.bottomRuleEl.style.display = "none", this.scroller.clear(), l.forEach(c.uncompensateScroll), this.dayGrid && (this.dayGrid.removeSegPopover(), i = this.opt("eventLimit"), i && "number" != typeof i && (i = 5), i && this.dayGrid.limitRows(i)), n || (o = this.computeScrollerHeight(e), this.scroller.setHeight(o), s = this.scroller.getScrollbarWidths(), (s.left || s.right) && (l.forEach(function(t) {
                        c.compensateScroll(t, s)
                    }), o = this.computeScrollerHeight(e), this.scroller.setHeight(o)), this.scroller.lockOverflow(s), this.timeGrid.getTotalSlatHeight() < o && (this.timeGrid.bottomRuleEl.style.display = ""))
                }, e.prototype.computeScrollerHeight = function(t) {
        ...
        e.default = v, v.prototype.timeGridClass = f.default, v.prototype.dayGridClass = g.default, i = {
        ...
        var r = n(2),
            ...
            E = function(t) {
                ...
                return r.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
                    ...
                    e = i.duration(e), n = n ? i.duration(n) : e, this.slotDuration = e, this.snapDuration = n, this.snapsPerSlot = e / n, t = this.opt("slotLabelFormat"), Array.isArray(t) && (t = t[t.length - 1]), this.labelFormat = t || this.opt("smallTimeFormat"), t = this.opt("slotLabelInterval"), this.labelInterval = t ? i.duration(t) : this.computeLabelInterval(e)
                }, e.prototype.computeLabelInterval = function(t) {
                    var e, n, r;
                    for (e = b.length - 1; e >= 0; e--)
                        if (n = i.duration(b[e]), r = s.divideDurationByDuration(n, t), l.isInt(r) && r > 1) return n;
                    return i.duration(t)
                }, e.prototype.renderDates = function(t) {
                    ...
                    var t = this.view.calendar.theme;
                    this.el.innerHTML = '<div class="fc-bg"></div><div class="fc-slats"></div><hr class="fc-divider ' + t.getClass("widgetHeader") + '" style="display:none" />', this.rootBgContainerEl = this.el.querySelector(".fc-bg"), this.slatContainerEl = this.el.querySelector(".fc-slats"), this.bottomRuleEl = this.el.querySelector(".fc-divider")
                }, e.prototype.renderSlats = function() {
                    var t = this.view.calendar.theme;
                    this.slatContainerEl.innerHTML = '<table class="' + t.getClass("tableGrid") + '">' + this.renderSlatRowHtml() + "</table>", this.slatEls = a.findElements(this.slatContainerEl, "tr"), this.slatCoordCache = new h.default({
                        els: this.slatEls,
                        isVertical: !0
                    })
                }, e.prototype.renderSlatRowHtml = function() {
                    for (var t, e, n, r = this.view, a = r.calendar, u = a.theme, d = this.isRTL, c = this.dateProfile, p = "", h = i.duration(+c.minTime), f = i.duration(0); h < c.maxTime;) t = a.msToUtcMoment(c.renderUnzonedRange.startMs).time(h), e = l.isInt(s.divideDurationByDuration(f, this.labelInterval)), n = '<td class="fc-axis fc-time ' + u.getClass("widgetContent") + '" ' + r.axisStyleAttr() + ">" + (e ? "<span>" + o.htmlEscape(t.format(this.labelFormat)) + "</span>" : "") + "</td>", p += '<tr data-time="' + t.format("HH:mm:ss") + '"' + (e ? "" : ' class="fc-minor"') + ">" + (d ? "" : n) + '<td class="' + u.getClass("widgetContent") + '"></td>' + (d ? n : "") + "</tr>", h.add(this.slotDuration), f.add(this.slotDuration);
                    return p
                }, e.prototype.renderColumns = function() {
                    var t = this.dateProfile,
                        e = this.view.calendar.theme;
                    this.dayRanges = this.dayDates.map(function(e) {
                        return new f.default(e.clone().add(t.minTime), e.clone().add(t.maxTime))
                    }), this.headContainerEl && (this.headContainerEl.innerHTML = this.renderHeadHtml()), this.rootBgContainerEl.innerHTML = '<table class="' + e.getClass("tableGrid") + '">' + this.renderBgTrHtml(0) + "</table>", this.colEls = a.findElements(this.el, ".fc-day, .fc-disabled-day"), this.colCoordCache = new h.default({
                        els: this.colEls,
                        isHorizontal: !0
                    ...
                    for (n = 0; n < this.colCnt; n++)
                        for (r = t[n], i = 0; i < r.length; i++) e[n].appendChild(r[i].el)
                }, e.prototype.getNowIndicatorUnit = function() {
                    return "minute"
                }, e.prototype.renderNowIndicator = function(t) {
                    if (this.colContainerEls) {
                        var e, n = this.componentFootprintToSegs(new g.default(new f.default(t, t.valueOf() + 1), !1)),
                        ...
                        for (e = 0; e < n.length; e++) {
                            ...
                            o.style.top = r + "px", this.colContainerEls[n[e].col].appendChild(o), i.push(o)
                        }
                        if (n.length > 0) {
                    ...
                    this.nowIndicatorEls && (this.nowIndicatorEls.forEach(a.removeElement), this.nowIndicatorEls = null)
                }, e.prototype.updateSize = function(e, n, r) {
                    ...
                    return this.computeTimeTop(i.duration(t - e.clone().stripTime()))
                    ...
                    var e, n;
                    for (e = 0; e < t.length; e++) n = t[e], a.applyStyle(n.el, this.generateSegVerticalCss(n))
                    ...
                    return n.time(r), e = n.clone().add(this.snapDuration), new g.default(new f.default(n, e), !1)
                }, e.prototype.computeSnapTime = function(t) {
                    return i.duration(this.dateProfile.minTime + this.snapDuration * t)
                }, e.prototype.getHitEl = function(t) {
                    return this.colEls[t.col]
                }, e.prototype.renderDrag = function(t, e, n) {
                    var r;
                    if (e) {
        ...
        e.default = E, E.prototype.eventRendererClass = v.default, E.prototype.businessHourRendererClass = d.default, E.prototype.helperRendererClass = y.default, E.prototype.fillRendererClass = m.default, c.default.mixInto(E), p.default.mixInto(E)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        ...
        var r = n(2),
            ...
            p = function(t) {
                function e(e, n) {
                    var r = t.call(this, e, n) || this;
                    return r.segSelector = ".fc-list-item", r.scroller = new u.default({
                        overflowX: "hidden",
                        overflowY: "auto"
                    }), r
                }
                return r.__extends(e, t), e.prototype.renderSkeleton = function() {
                    ...
                    var t = this.calendar.theme.getClass("listView");
                    t && this.el.classList.add(t), this.scroller.render(), this.el.appendChild(this.scroller.el), this.contentEl = this.scroller.scrollEl
                }, e.prototype.unrenderSkeleton = function() {
                    ...
                    for (var e = this.calendar, n = e.msToUtcMoment(t.renderUnzonedRange.startMs, !0), r = e.msToUtcMoment(t.renderUnzonedRange.endMs, !0), i = [], o = []; n < r;) i.push(n.clone()), o.push(new a.default(n, n.clone().add(1, "day"))), n.add(1, "day");
                    ...
                    this.contentEl.innerHTML = '<div class="fc-list-empty-wrap2"><div class="fc-list-empty-wrap1"><div class="fc-list-empty">' + o.htmlEscape(this.opt("noEventsMessage")) + "</div></div></div>"
                }, e.prototype.renderSegList = function(t) {
                    var e, n, r, o = this.groupSegsByDay(t),
                        s = i.htmlToElement('<table class="fc-list-table ' + this.calendar.theme.getClass("tableList") + '"><tbody></tbody></table>'),
                        a = s.querySelector("tbody");
                    for (e = 0; e < o.length; e++)
                        if (n = o[e])
                            for (a.appendChild(this.buildDayHeaderRow(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), r = 0; r < n.length; r++) a.appendChild(n[r].el);
                    ...
                    return r
                }, e.prototype.buildDayHeaderRow = function(t) {
                    var e = this.opt("listDayFormat"),
                        n = this.opt("listDayAltFormat");
                    return i.createElement("tr", {
                        className: "fc-list-heading",
                        "data-date": t.format("YYYY-MM-DD")
                    }, '<td class="' + (this.calendar.theme.getClass("tableListHeading") || this.calendar.theme.getClass("widgetHeader")) + '" colspan="3">' + (e ? this.buildGotoAnchorHtml(t, {
                        class: "fc-list-heading-main"
                    }, o.htmlEscape(t.format(e))) : "") + (n ? this.buildGotoAnchorHtml(t, {
                        class: "fc-list-heading-alt"
                    }, o.htmlEscape(t.format(n))) : "") + "</td>")
                }, e
            }(l.default);
        e.default = p, p.prototype.eventRendererClass = d.default, p.prototype.eventPointingClass = c.default
    }, , , , , , function(t, e, n) {
        var r = n(35);
        n(14), n(52), n(265), n(266), n(269), n(270), n(271), t.exports = r
    }, function(t, e) {
        function n(t, e, n) {
            var r = !1,
                i = function() {
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.setElement = function(t) {
                    ...
                    this.unset("isInDom"), this.unrenderSkeleton(), this.unbindGlobalHandlers(), i.removeElement(this.el)
        ...
        function r(t, e) {
            return null == e ? t : "function" == typeof e ? t.filter(e) : (e += "", t.filter(function(t) {
        ...
        var i = n(0),
            ...
            _ = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    if (Array.isArray(e) ? r = e : "object" == typeof e && e && (n = e.context, r = e.args), null == n && (n = this.el), r || (r = []), this.triggerWith(t, n, r), i) return i.apply(n, r)
                    ...
                    } else "object" == typeof t && t && this.optionsManager.add(t)
                    ...
                    var e = this,
                        n = this.el;
                    n.classList.add("fc"), this.removeNavLinkListener = a.listenBySelector(n, "click", "a[data-goto]", function(t, n) {
                        var r = n.getAttribute("data-goto");
                        r = r ? JSON.parse(r) : {};
                        var i = e.moment(r.date),
                            o = r.type,
                            s = e.view.opt("navLink" + l.capitaliseFirstLetter(o) + "Click");
                        "function" == typeof s ? s(i, t) : ("string" == typeof s && (o = s), e.zoomTo(i, o))
                    }), this.optionsManager.watch("settingTheme", ["?theme", "?themeSystem"], function(t) {
                        var r = P.getThemeSystemClass(t.themeSystem || t.theme),
                            i = new r(e.optionsManager),
                            o = i.getClass("widget");
                        e.theme = i, o && n.classList.add(o)
                    }, function() {
                        var t = e.theme.getClass("widget");
                        e.theme = null, t && n.classList.remove(t)
                    }), this.optionsManager.watch("settingBusinessHourGenerator", ["?businessHours"], function(t) {
                        e.businessHourGenerator = new C.default(t.businessHours, e), e.view && e.view.set("businessHourGenerator", e.businessHourGenerator)
                    }, function() {
                        e.businessHourGenerator = null
                    }), this.optionsManager.watch("applyingDirClasses", ["?isRTL", "?locale"], function(t) {
                        o.forceClassName(n, "fc-ltr", !t.isRTL), o.forceClassName(n, "fc-rtl", t.isRTL)
                    }), o.prependToElement(n, this.contentEl = o.createElement("div", {
                        className: "fc-view-container"
                    })), this.initToolbars(), this.renderHeader(), this.renderFooter(), this.renderView(this.opt("defaultView")), this.opt("handleWindowResize") && window.addEventListener("resize", this.windowResizeProxy = l.debounce(this.windowResize.bind(this), this.opt("windowResizeDelay"))), this.trigger("initialRender"), t.trigger("initialRender", this)
                }, t.prototype.destroy = function() {
                    var e = Boolean(this.contentEl && this.contentEl.parentNode);
                    this.view && this.clearView(), this.toolbarsManager.proxyCall("removeElement"), o.removeElement(this.contentEl), this.el.classList.remove("fc"), this.el.classList.remove("fc-ltr"), this.el.classList.remove("fc-rtl"), this.optionsManager.unwatch("settingTheme"), this.optionsManager.unwatch("settingBusinessHourGenerator"), this.removeNavLinkListener && (this.removeNavLinkListener(), this.removeNavLinkListener = null), this.windowResizeProxy && (window.removeEventListener("resize", this.windowResizeProxy), this.windowResizeProxy = null), e && (c.default.unneeded(), this.trigger("destroy"), t.trigger("destroy", this))
                    ...
                    var e, n = this.view;
                    if (this.freezeContentHeight(), n && t && n.type !== t && this.clearView(), !this.view && t) {
                        e = this.view = this.viewsByType[t] || (this.viewsByType[t] = this.instantiateView(t)), this.bindViewHandlers(e), e.startBatchRender();
                        var r = o.createElement("div", {
                            className: "fc-view fc-" + t + "-view"
                        });
                        this.contentEl.appendChild(r), e.setElement(r), this.toolbarsManager.proxyCall("activateButton", t)
                    }
                    this.view && (this.view.get("businessHourGenerator") !== this.businessHourGenerator && this.view.set("businessHourGenerator", this.businessHourGenerator), this.view.setDate(this.currentDate), e && e.stopBatchRender()), this.thawContentHeight()
                    ...
                    var t = this.opt("contentHeight"),
                        e = this.opt("height");
                    this.suggestedViewHeight = "number" == typeof t ? t : "function" == typeof t ? t() : "number" == typeof e ? e - this.queryToolbarsHeight() : "function" == typeof e ? e() - this.queryToolbarsHeight() : "parent" === e ? this.el.parentNode.offsetHeight - this.queryToolbarsHeight() : Math.round(this.contentEl.offsetWidth / Math.max(this.opt("aspectRatio"), .5))
                    ...
                    o.applyStyle(this.contentEl, {
                        width: "100%",
                        height: this.contentEl.offsetHeight,
                        overflow: "hidden"
                    })
                }, t.prototype.thawContentHeight = function() {
                    this.freezeContentHeightDepth--, o.applyStyle(this.contentEl, {
                        width: "",
                        height: "",
                        overflow: ""
                    }), this.freezeContentHeightDepth && this.forceFreezeContentHeight()
                }, t.prototype.initToolbars = function() {
                    this.header = new f.default(this, this.computeHeaderOptions()), this.footer = new f.default(this, this.computeFooterOptions()), this.toolbarsManager = new d.default([this.header, this.footer])
                    ...
                    var t = this.header;
                    t.setToolbarOptions(this.computeHeaderOptions()), t.render(), t.el && o.prependToElement(this.el, t.el)
                }, t.prototype.renderFooter = function() {
                    var t = this.footer;
                    t.setToolbarOptions(this.computeFooterOptions()), t.render(), t.el && this.el.appendChild(t.el)
                    ...
                    return this.toolbarsManager.items.reduce(function(t, e) {
                        return t + (e.el ? s.computeHeightAndMargins(e.el) : 0)
                    }, 0)
                    ...
                    return n = e ? this.moment(e).stripZone() : r.hasTime() ? r.clone().add(this.defaultTimedEventDuration) : r.clone().add(this.defaultAllDayEventDuration), new w.default(new E.default(r, n), !r.hasTime())
                }, t.prototype.handlExternalDragStart = function(t, e, n) {
                    this.view && this.view.handlExternalDragStart(t, e, n)
                }, t.prototype.handleExternalDragMove = function(t) {
                    this.view && this.view.handleExternalDragMove(t)
                }, t.prototype.handleExternalDragStop = function(t) {
                    this.view && this.view.handleExternalDragStop(t)
                    ...
                    this.defaultAllDayEventDuration = i.duration(this.opt("defaultAllDayEventDuration")), this.defaultTimedEventDuration = i.duration(this.opt("defaultTimedEventDuration")), this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function(e) {
                        var n, r = e.weekNumberCalculation,
                            i = e.firstDay;
                        "iso" === r && (r = "ISO");
                        var o = Object.create(m.getMomentLocaleData(e.locale));
                    ...
                    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                    var n;
                    return "local" === this.opt("timezone") ? (n = b.default.apply(null, t), n.hasTime() && n.local()) : n = "UTC" === this.opt("timezone") ? b.default.utc.apply(null, t) : b.default.parseZone.apply(null, t), this.localizeMoment(n), n
                }, t.prototype.msToMoment = function(t, e) {
                    var n = b.default.utc(t);
                    ...
                    void 0 === e && (e = !1);
                    var n, r = b.default.utc(t.unzonedRange.startMs);
                    return e || (n = b.default.utc(t.unzonedRange.endMs)), t.isAllDay ? (r.stripTime(), n && n.stripTime()) : (r = this.applyTimezone(r), n && (n = this.applyTimezone(n))), new D.default(r, n, this)
                    ...
                    var e = null,
                        n = null;
                    return t.start && (e = this.moment(t.start).stripZone()), t.end && (n = this.moment(t.end).stripZone()), e || n ? e && n && n.isBefore(e) ? null : new E.default(e, n) : null
                }, t.prototype.initEventManager = function() {
                    var t = this,
                        e = new S.default(this),
                    ...
                    this.eventManager = e, r && n.unshift(r), e.on("release", function(e) {
                        ...
                        var r = T.default.parse(n, t);
                        r && e.addSource(r)
                    }), e.thaw()
                }, t.prototype.requestEvents = function(t, e, n) {
                    return this.eventManager.requestEvents(t, e, this.opt("timezone"), !this.opt("lazyFetching"), n)
                    ...
                    var n = this.eventManager,
                        r = R.default.parse(t, t.source || n.stickySource);
                    r && n.addEventDef(r, e)
                    ...
                    r instanceof M.default && (e = r.buildInstance(), n = I.default.createFromRawProps(e, t, null), this.eventManager.mutateEventsWithId(r.id, n))
                }, t.prototype.getEventSources = function() {
                    return this.eventManager.otherSources.slice()
                }, t.prototype.getEventSourceById = function(t) {
                    return this.eventManager.getSourceById(H.default.normalizeId(t))
                }, t.prototype.addEventSource = function(t) {
                    var e = T.default.parse(t, this);
                    ...
                    n.thaw()
                }, t.defaults = u.globalDefaults, t.englishDefaults = u.englishDefaults, t.rtlDefaults = u.rtlDefaults, t
            }();
        e.default = _, p.default.mixIntoObj(_), p.default.mixInto(_), h.default.mixInto(_)
    }, function(t, e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
            ...
            o = function() {
                ...
                return t.prototype.setToolbarOptions = function(t) {
                    ...
                    var t = this.toolbarOptions.layout,
                        e = this.el;
                    t ? (e ? e.innerHTML = "" : e = this.el = i.createElement("div", {
                        className: "fc-toolbar " + this.toolbarOptions.extraClasses
                    }), i.appendToElement(e, this.renderSection("left")), i.appendToElement(e, this.renderSection("right")), i.appendToElement(e, this.renderSection("center")), i.appendToElement(e, '<div class="fc-clear"></div>')) : this.removeElement()
                }, t.prototype.removeElement = function() {
                    this.el && (i.removeElement(this.el), this.el = null)
                    ...
                    var e = this,
                        ...
                        p = s.get("buttonText") || {};
                    return u && u.split(" ").forEach(function(t, s) {
                        var u, h = [],
                            f = !0;
                        if (t.split(",").forEach(function(t, s) {
                                var l, u, g, v, y, m, b, E, w;
                                if ("title" === t) h.push(i.htmlToElement("<h2>&nbsp;</h2>")), f = !1;
                                else if ((l = d[t]) ? (g = function(t) {
                                        l.click && l.click.call(E, t)
                                    }, (v = o.getCustomButtonIconClass(l)) || (v = o.getIconClass(t)) || (y = l.text)) : (u = a.getViewSpec(t)) ? (e.viewsWithButtons.push(t), g = function() {
                                        n.changeView(t)
                                    }, (y = u.buttonTextOverride) || (v = o.getIconClass(t)) || (y = u.buttonTextDefault)) : n[t] && (g = function() {
                                        n[t]()
                                    }, (y = c[t]) || (v = o.getIconClass(t)) || (y = p[t])), g) {
                                    b = ["fc-" + t + "-button", o.getClass("button"), o.getClass("stateDefault")], y ? (m = r.htmlEscape(y), w = "") : v && (m = "<span class='" + v + "'></span>", w = ' aria-label="' + t + '"'), E = i.htmlToElement('<button type="button" class="' + b.join(" ") + '"' + w + ">" + m + "</button>");
                                    var D = function() {
                                        var t = o.getClass("stateActive"),
                                            e = o.getClass("stateDisabled");
                                        return !(t && E.classList.contains(t) || e && E.classList.contains(e))
                                    };
                                    E.addEventListener("click", function(t) {
                                        var e = o.getClass("stateDisabled"),
                                            n = o.getClass("stateHover");
                                        e && E.classList.contains(e) || (g(t), !D() && n && E.classList.remove(n))
                                    }), E.addEventListener("mousedown", function(t) {
                                        var e = o.getClass("stateDown");
                                        D() && e && E.classList.add(e)
                                    }), E.addEventListener("mouseup", function(t) {
                                        var e = o.getClass("stateDown");
                                        e && E.classList.remove(e)
                                    }), E.addEventListener("mouseenter", function(t) {
                                        var e = o.getClass("stateHover");
                                        D() && e && E.classList.add(e)
                                    }), E.addEventListener("mouseleave", function(t) {
                                        var e = o.getClass("stateHover"),
                                            n = o.getClass("stateDown");
                                        e && E.classList.remove(e), n && E.classList.remove(n)
                                    }), h.push(E)
                                }
                            }), f && h.length > 0) {
                            var g = o.getClass("cornerLeft"),
                                v = o.getClass("cornerRight");
                            g && h[0].classList.add(g), v && h[h.length - 1].classList.add(v)
                        }
                        if (h.length > 1) {
                            u = document.createElement("div");
                            var y = o.getClass("buttonGroup");
                            f && y && u.classList.add(y), i.appendToElement(u, h), l.appendChild(u)
                        } else i.appendToElement(l, h)
                    }), l
                }, t.prototype.updateTitle = function(t) {
                    this.el && i.findElements(this.el, "h2").forEach(function(e) {
                        e.innerText = t
                    })
                }, t.prototype.activateButton = function(t) {
                    var e = this;
                    this.el && i.findElements(this.el, ".fc-" + t + "-button").forEach(function(t) {
                        t.classList.add(e.calendar.theme.getClass("stateActive"))
                    })
                }, t.prototype.deactivateButton = function(t) {
                    var e = this;
                    this.el && i.findElements(this.el, ".fc-" + t + "-button").forEach(function(t) {
                        t.classList.remove(e.calendar.theme.getClass("stateActive"))
                    })
                }, t.prototype.disableButton = function(t) {
                    var e = this;
                    this.el && i.findElements(this.el, ".fc-" + t + "-button").forEach(function(t) {
                        t.disabled = !0, t.classList.add(e.calendar.theme.getClass("stateDisabled"))
                    })
                }, t.prototype.enableButton = function(t) {
                    var e = this;
                    this.el && i.findElements(this.el, ".fc-" + t + "-button").forEach(function(t) {
                        t.disabled = !1, t.classList.remove(e.calendar.theme.getClass("stateDisabled"))
                    })
        ...
        var r = n(2),
            ...
            u = function(t) {
                function e(e, n) {
                    var r = t.call(this) || this;
                    return r._calendar = e, r.overrides = i.assignTo({}, n), r.dynamicOverrides = {}, r.compute(), r
                }
        ...
        var r = n(0),
            ...
            u = function() {
                ...
                return t.prototype.clearCache = function() {
                    ...
                    var e, n, r;
                    if (-1 !== s.unitsDesc.indexOf(t)) {
                        e = this._calendar.header.getViewsWithButtons();
                        for (var o in i.viewHash) e.push(o);
                        for (n = 0; n < e.length; n++)
                            if ((r = this.getViewSpec(e[n])) && r.singleUnit === t) return r
                    }
                }, t.prototype.buildViewSpec = function(t) {
                    for (var e, n, l, u, d, c = this.optionsManager.overrides.views || {}, p = [], h = [], f = [], g = t; g;) e = i.viewHash[g], n = c[g], g = null, "function" == typeof e && (e = {
                        class: e
                    }), e && (p.unshift(e), h.unshift(e.defaults || {}), l = l || e.duration, g = g || e.type), n && (f.unshift(n), l = l || n.duration, g = g || n.type);
        ...
        var i = n(21),
            ...
            h = function() {
                ...
                return t.prototype.requestEvents = function(t, e, n, r, i) {
                    !r && this.currentPeriod && this.currentPeriod.isWithinRange(t, e) && n === this.currentPeriod.timezone || this.setPeriod(new o.default(t, e, n)), this.currentPeriod.whenReleased(i)
                    ...
                    for (e = 0; e < i.length; e++)
                        if ((n = i[e]) === t) return [n];
                    return (n = this.getSourceById(a.default.normalizeId(t))) ? [n] : (t = l.default.parse(t, this.calendar), t ? i.filter(function(e) {
                        return r(t, e)
                    }) : void 0)
                }, t.prototype.getSourceById = function(t) {
                    return this.otherSources.filter(function(e) {
                        return e.id && e.id === t
                    })[0]
        ...
        var r = n(21),
            ...
            l = function() {
                function t(t, e, n) {
                    this.pendingCnt = 0, this.freezeDepth = 0, this.stuntedReleaseCnt = 0, this.releaseCnt = 0, this.start = t, this.end = e, this.timezone = n, this.unzonedRange = new s.default(t.clone().stripZone(), e.clone().stripZone()), this.requestsByUid = {}, this.eventDefsByUid = {}, this.eventDefsById = {}, this.eventInstanceGroupsById = {}
                }
                return t.prototype.isWithinRange = function(t, e) {
                    ...
                    this.requestsByUid[t.uid] = n, this.pendingCnt += 1, t.fetch(this.start, this.end, this.timezone, function(t) {
                    ...
                    (n[e] || (n[e] = new a.default)).eventInstances.push(t), this.tryRelease()
                ...
                }, t.prototype.whenReleased = function(t) {
                    this.releaseCnt ? t(this.eventInstanceGroupsById) : this.one("release", t)
                }, t.prototype.freeze = function() {
        ...
        e.default = l, o.default.mixInto(l)
    }, function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var r = n(10),
            ...
            s = function() {
                function t(t, e) {
                    this.isFollowing = !1, this.isHidden = !1, this.isAnimating = !1, this.options = e = e || {}, this.sourceEl = t, this.parentEl = e.parentEl || t.parentNode
                }
                return t.prototype.start = function(t) {
                    this.isFollowing || (this.isFollowing = !0, this.y0 = r.getEvY(t), this.x0 = r.getEvX(t), this.topDelta = 0, this.leftDelta = 0, this.isHidden || this.updatePosition(), r.getEvIsTouch(t) ? this.listenTo(document, "touchmove", this.handleMove) : this.listenTo(document, "mousemove", this.handleMove))
                    ...
                    this.isFollowing && !this.isAnimating && (this.isFollowing = !1, this.stopListeningTo(document), t && s && !this.isHidden ? (this.isAnimating = !0, o.style.transition = "top " + s + "ms, left " + s + "ms", i.applyStyle(o, {
                        top: this.top0,
                        left: this.left0
                    }), r.whenTransitionDone(o, function() {
                        o.style.transition = "", a()
                    })) : a())
                }, t.prototype.getEl = function() {
                    var t = this.el;
                    return t || (t = this.el = this.sourceEl.cloneNode(!0), t.classList.add("fc-unselectable"), this.options.additionalClass && t.classList.add(this.options.additionalClass), i.applyStyle(t, {
                        position: "absolute",
                        visibility: "",
                    ...
                    }), this.parentEl.appendChild(t)), t
                }, t.prototype.removeElement = function() {
                    this.el && (i.removeElement(this.el), this.el = null)
                }, t.prototype.updatePosition = function() {
                    var t, e, n = this.getEl();
                    null == this.top0 && (t = this.sourceEl.getBoundingClientRect(), e = n.offsetParent.getBoundingClientRect(), this.top0 = t.top - e.top, this.left0 = t.left - e.left), i.applyStyle(n, {
                    ...
                    this.isHidden || (this.isHidden = !0, this.el && (this.el.style.display = "none"))
                }, t.prototype.show = function() {
                    this.isHidden && (this.isHidden = !1, this.updatePosition(), this.getEl().style.display = "")
                }, t
            }();
        ...
        var l = n(2),
            ...
            p = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    t.sort(this.compareForwardSegs.bind(this))
                }, e.prototype.compareForwardSegs = function(t, e) {
                    return e.forwardPressure - t.forwardPressure || (t.backwardCoord || 0) - (e.backwardCoord || 0) || this.compareEventSegs(t, e)
                }, e.prototype.assignFgSegHorizontals = function(t) {
                    var e, n;
                    for (e = 0; e < t.length; e++) n = t[e], d.applyStyle(n.el, this.generateFgSegHorizontalCss(n)), n.bottom - n.top < 30 && n.el.classList.add("fc-short")
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderSegs = function(t, e) {
                    var n, r, o, s, a = [];
                    for (this.eventRenderer.renderFgSegsIntoContainers(t, this.component.helperContainerEls), n = 0; n < t.length; n++) r = t[n], e && e.col === r.col && (o = e.el, s = window.getComputedStyle(o), i.applyStyle(r.el, {
                        left: s.left,
                        right: s.right,
        ...
        var r = n(3),
            ...
            a = function() {
                ...
                return t.prototype.show = function() {
                    ...
                    e.parentEl.appendChild(n), i.listenBySelector(n, "click", ".fc-close", function(e) {
                        t.hide()
                    ...
                    this.hide(), this.el && (r.removeElement(this.el), this.el = null), this.stopListeningTo(document, "mousedown")
                }, t.prototype.position = function() {
                    var t, e, n, i = this.options,
                        s = this.el,
                        a = s.getBoundingClientRect(),
                        l = o.getScrollParent(s);
                    e = i.top || 0, n = void 0 !== i.left ? i.left : void 0 !== i.right ? i.right - a.width : 0, t = l ? l.getBoundingClientRect() : {
                        top: 0,
                        left: 0,
                        width: document.documentElement.clientWidth,
                        height: document.documentElement.clientHeight
                    }, !1 !== i.viewportConstrain && (e = Math.min(e, t.top + t.height - a.height - this.margin), e = Math.max(e, t.top + this.margin), n = Math.min(n, t.left + t.width - a.width - this.margin), n = Math.max(n, t.left + this.margin)), r.applyStyle(s, {
                        top: e - a.top,
                        left: n - a.left
                    })
                }, t.prototype.trigger = function(t) {
        ...
        e.default = a, s.default.mixInto(a)
    }, function(t, e, n) {
        function r(t, e) {
            var n, r;
            for (n = 0; n < e.length; n++)
        ...
        var o = n(2),
            ...
            u = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    this.dayGrid.rowEls.forEach(function(t, n) {
                        t.querySelector(".fc-content-skeleton > table").appendChild(e[n].tbodyEl)
                    })
                }, e.prototype.unrenderFgSegs = function() {
                    for (var t, e = this.rowStructs || []; t = e.pop();) a.removeElement(t.tbodyEl);
                    ...
                    function n(t) {
                        for (; o < t;) d = (y[r - 1] || [])[o], d ? d.rowSpan = (d.rowSpan || 1) + 1 : (d = document.createElement("td"), s.appendChild(d)), v[r][o] = d, y[r][o] = d, o++
                    }
                    var r, i, o, s, l, u, d, c = this.dayGrid.colCnt,
                        ...
                        y = [];
                    for (r = 0; r < h; r++) {
                        if (i = p[r], o = 0, s = document.createElement("tr"), g.push([]), v.push([]), y.push([]), i)
                            for (l = 0; l < i.length; l++) {
                                for (u = i[l], n(u.leftCol), d = a.createElement("td", {
                                        className: "fc-event-container"
                                    }, u.el), u.leftCol !== u.rightCol ? d.colSpan = u.rightCol - u.leftCol + 1 : y[r][o] = d; o <= u.rightCol;) v[r][o] = d, g[r][o] = u, o++;
                                s.appendChild(d)
                            }
                        n(c), this.dayGrid.bookendCells(s), f.appendChild(s)
                    }
                    return {
                        row: t,
                        tbodyEl: f,
                    ...
                    var n, r, i = this.view,
                        ...
                        u = !e && a && t.isStart && i.isEventDefResizableFromStart(o),
                        d = !e && a && t.isEnd && i.isEventDefResizableFromEnd(o),
                        c = this.getSegClasses(t, l, u || d),
                        p = s.cssToStr(this.getSkinCss(o)),
                        h = "";
                    return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + s.htmlEscape(n) + "</span>"), r = '<span class="fc-title">' + (s.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="' + c.join(" ") + '"' + (o.url ? ' href="' + s.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (d ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.renderSegs = function(t, e) {
                    var n, r = [];
                    return n = this.eventRenderer.renderSegRows(t), this.component.rowEls.forEach(function(t, o) {
                        var s, a, l = i.htmlToElement('<div class="fc-helper-skeleton"><table></table></div>');
                        e && e.row === o ? s = e.el : (s = t.querySelector(".fc-content-skeleton tbody")) || (s = t.querySelector(".fc-content-skeleton table")), a = s.getBoundingClientRect().top - t.getBoundingClientRect().top, l.style.top = a + "px", l.querySelector("table").appendChild(n[o].tbodyEl), t.appendChild(l), r.push(l)
                    }), r
                }, e
            }(o.default);
        e.default = s
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.attachSegEls = function(t, e) {
                    var n, r, i, o = [];
                    for (n = 0; n < e.length; n++) r = e[n], i = this.renderFillRow(t, r), this.component.rowEls[r.row].appendChild(i), o.push(i);
                    return o
                }, e.prototype.renderFillRow = function(t, e) {
                    var n, r, o, s = this.component.colCnt,
                        a = e.leftCol,
                        l = e.rightCol + 1;
                    return n = "businessHours" === t ? "bgevent" : t.toLowerCase(), r = i.htmlToElement('<div class="fc-' + n + '-skeleton"><table><tr></tr></table></div>'), o = r.getElementsByTagName("tr")[0], a > 0 && o.appendChild(i.createElement("td", {
                        colSpan: a
                    })), e.el.colSpan = l - a, o.appendChild(e.el), l < s && o.appendChild(i.createElement("td", {
                        colSpan: s - l
                    })), this.component.bookendCells(o), r
                }, e
            }(o.default);
        e.default = s
    }, function(t, e, n) {
        ...
        var r = n(2),
            ...
            s = function(t) {
                ...
                return r.__extends(e, t), e.prototype.handleClick = function(e, n) {
                    var r;
                    t.prototype.handleClick.call(this, e, n), i.elementClosest(n.target, "a[href]") || (r = e.footprint.eventDef.url) && !n.isDefaultPrevented() && (window.location.href = r)
                }, e
            }(o.default);
        e.default = s
    }, function(t, e, n) {
